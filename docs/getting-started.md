...
When [endorlabs/endorlabs-buildkite-plugin](https://github.com/endorlabs/endorlabs-buildkite-plugin)
is public and tagged, you may switch the plugin key to:
...
| `hooks/` (we use `post-command` only) | [hooks/post-command](../hooks/post-command) |
