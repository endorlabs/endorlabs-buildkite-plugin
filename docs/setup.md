...
**Public plugin ref:** use `https://github.com/endorlabs/endorlabs-buildkite-plugin.git#v0.1.8` until `endorlabs#v0.1.8` appears in the [plugins directory](https://buildkite.com/docs/integrations/buildkite-plugins). Vendoring still works for air-gapped or cross-org constraints.
